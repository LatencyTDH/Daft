...
class DataFrame:
    ...
    def to_ray_dataset(self) -> "ray.data.dataset.DataSet":
        ...
        from daft.runners.ray_runner import micropartition_to_ray_dataset_block

        blocks = [micropartition_to_ray_dataset_block(result.micropartition()) for _, result in partition_set.items()]
